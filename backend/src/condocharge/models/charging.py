...
class AgentState(Base):
    ...
    agent_started_at: Mapped[datetime | None] = mapped_column(UtcAwareDateTime(), nullable=True)
    last_heartbeat_at: Mapped[datetime | None] = mapped_column(UtcAwareDateTime(), nullable=True)
    last_heartbeat_sent_at: Mapped[datetime | None] = mapped_column(UtcAwareDateTime(), nullable=True)
